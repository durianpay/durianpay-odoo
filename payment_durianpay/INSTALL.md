# Durianpay × Odoo 19 — Install & Usage Guide

This guide covers setting up **Odoo 19** from source and installing/using the
...
> Target version: **Odoo 19**. The module uses the Odoo 19 payment API and is not compatible
> with 17/18 as-is.
...
> Odoo automatically also loads its base modules from `odoo19/odoo/addons`.
